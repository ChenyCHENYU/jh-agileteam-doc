...
欢迎使用由金恒科技共享技术中心牵头、联合信息化中心共建的前端工程体系！本指南将帮助你快速上手我们的前端工程化实践。
...
- **Node.js**: >= 22.12（22 LTS 或 24.x，模板 engines 强制）
- **包管理器**: pnpm >= 10.18.0 （团队推荐）或 npm >= 9.0.0
...
金恒科技共享技术中心联合信息化中心共建的前端团队欢迎任何形式的贡献：
...
::: tip 提示
建议先阅读完整个指南版块，然后动手实践，这样能更快地掌握由金恒科技共享技术中心牵头、联合信息化中心共建的前端工程体系！如有疑问，请随时通过内部工号 409322取得联系或直接评论区留言。
:::
