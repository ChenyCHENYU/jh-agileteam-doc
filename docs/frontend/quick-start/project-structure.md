...
了解金恒科技共享技术中心前端团队的项目目录结构有助于你更好地组织和管理代码，适应不同的业务场景。

## 标准目录结构

金恒科技共享技术中心前端团队推荐以下标准目录结构：
...
::: tip 提示
良好的项目结构是金恒科技共享技术中心前端团队协作的基础，请遵循统一的目录规范和命名约定！如有特殊需求，请联系团队负责人或通过内部工单系统 409322 提交需求。
:::
