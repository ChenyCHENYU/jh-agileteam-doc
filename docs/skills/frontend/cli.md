...
::: warning ⚠️ 本页已迁移
本页内容已过期并迁移至 **[前端 PC 端 Skills — CLI 工具](/frontend/pc/skills/cli)**（对应 `@agile-team/wl-skills-kit` v2.11.5，现已提供 `init / update / clean / check / diff / validate / validate-page / fix / doctor-ui / export / mock-clean` 等 11 个 CLI 子命令）。请前往新位置查看最新内容。
:::
