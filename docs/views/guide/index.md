...
| [L3 — MCP 工具调用](/views/best-practices/L3-skills-mcp) | 23 个 Tool，菜单/字典/权限/项目感知/环境标准化全覆盖 | ✅ 已实现 |
| [L4 — CLI](/views/best-practices/L4-cli) | 14 条命令：init / update / clean / check / diff / validate / validate-page / fix / doctor-ui / export / mock-clean / contract / component / standard-env | ✅ 已实现 |
